...
extern void quat_scale(struct quaternion* quat, struct quaternion* other);

extern double quat_mag(struct quaternion* quat);
extern void quat_norm(struct quaternion* quat);
extern void quat_conj(struct quaternion* quat);

extern void quat_inverse(struct quaternion* quat);
